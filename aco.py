...
def select_path(
    ...
    if precomputed_paths is not None:
        # Performance optimization: use precomputed paths and filter by existing edges
        # This avoids expensive nx.all_simple_paths calls on the dynamically mutated graph
        paths = [
