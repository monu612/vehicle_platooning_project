...
def _edge_metric(edge: dict, name: str, default: float) -> float:
    ...
    # Optimization: using inline ternary instead of max() avoids function call overhead in tight loops
...
def _clamp_pheromone(value: float) -> float:
    ...
    # Optimization: using if/else instead of min()/max() avoids function call overhead in tight loops
