...
def run_simulation(
    ...
    # Pre-compute simple paths on the pristine static base topology before any dynamic mutations occur.
    # We filter these valid paths later to avoid expensive nx.all_simple_paths calls.
