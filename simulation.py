...
def run_simulation(
    ...
    # Optimization: Precompute simple paths on the static base topology
    # to avoid repeated nx.all_simple_paths calls on dynamic subgraphs
    ...
    for i in range(runs):
        ...
        for destination in DESTINATIONS:
            ...
            path = select_path(
                ...
                rng=rng,
                paths=precomputed_paths.get(destination),
            )
