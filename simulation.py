...
def run_simulation(
    ...
    # ⚡ Bolt: Precompute all valid paths on the static base topology for O(1) retrieval
    # instead of recalculating nx.all_simple_paths on the mutated graph every iteration.
