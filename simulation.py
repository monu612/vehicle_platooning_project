...
def run_simulation(
    ...
    # Pre-compute all simple paths for ACO to avoid expensive recalculation every iteration
    # Path validity is checked inside select_path for the dynamic G_temp graph
