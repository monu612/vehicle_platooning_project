...
def run_simulation(
    ...
    for destination in DESTINATIONS:
        ...
        try:
            # Precompute all simple paths up to cutoff=4 on the pristine topology
            # ⚡ BOLT OPTIMIZATION: Compute paths once before dynamic network mutations
            # to avoid O(N^2) pathfinding on each disrupted graph in the simulation loop.
