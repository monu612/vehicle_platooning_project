...
def run_simulation(
    ...
    # Performance optimization: pre-compute all simple paths on the pristine static topology
    # to avoid expensive nx.all_simple_paths calls on the dynamically mutated graph.
